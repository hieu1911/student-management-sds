...
var studentController = new StudentService();
var subjectController = new SubjectService();
var studentSubjectController = new StudentSubjectService();
var studentManagement = new StudentManagement(studentController, subjectController, studentSubjectController);
